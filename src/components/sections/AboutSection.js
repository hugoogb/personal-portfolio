				...
				<div className={styles.aboutContainer}>
					<div className={styles.aboutTextContainer}>
						<p>
							...
							but I also develop{" "}
							<span style={{ color: color }}>mobile apps</span>{" "}
							using{" "}
						...
						<p>
							...
							such as <span style={{ color: color }}>React</span>{" "}
							and <span style={{ color: color }}>Vue </span>for
							frontend development. I love the challenge of
							creating{" "}
							<span style={{ color: color }}>responsive</span> and{" "}
							<span style={{ color: color }}>dynamic</span> user
							interfaces that enhance the user experience. Whether
							it
							{"'"}s a{" "}
							<span style={{ color: color }}>
								simple landing page
						...
						<p>
							...
							<span style={{ color: color }}>ExpressJS</span>.
							This allows me to create robust and scalable
							applications.
						</p>
					</div>
