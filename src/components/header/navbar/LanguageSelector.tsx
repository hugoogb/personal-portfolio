...
export const LanguageSelector: FC = () => {
  // Initialize with current i18n language to avoid flash of wrong language
  ...
  // Only change language after component has mounted (after hydration)
  useEffect(() => {
    if (!isMounted) return;
  ...
  }, [isMounted, changeLanguage, currentLanguage]);
    ...
    <div className={styles.languageSelectorContainer}>
      {languageOptions.map(({ code, label, flag }) => (
        ...
        >
          ...
          />
          <span
            style={currentLanguage === code ? { fontWeight: "600" } : {}}
